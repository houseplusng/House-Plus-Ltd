...
const blogPostsConfig = {
  en: [
    ...
    },
    {
      ...
      excerpt: 'Learn how to choose the right solar inverter for your home. Comparison of string inverters, microinverters, and hybrid inverters.',
      date: '2026-04-20',
      readTime: '7 min read',
      category: 'Solar Energy',
    ...
    },
    {
      ...
      excerpt: 'Comprehensive guide to the top 5 lithium battery manufacturers for European distributors. Compare features, certifications, and customization options.',
      date: '2026-04-20',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt: 'Complete breakdown of 5kW solar system costs in the US for 2026. Learn about equipment, labor, and how to reduce installation costs.',
      date: '2026-04-20',
      readTime: '6 min read',
      category: 'Solar Energy',
      author: 'House Plus Ltd',
  ...
  fr: [
    ...
    },
    {
      ...
      excerpt: 'Apprenez à choisir le bon onduleur solaire pour votre maison. Comparaison des onduleurs chaîne, micro-onduleurs et onduleurs hybrides.',
      date: '2026-04-20',
    ...
    {
      slug: 'lithium-battery-manufacturers',
      title: 'Top 5 des fabricants de batteries lithium pour les distributeurs européens',
      excerpt: 'Guide complet des 5 principaux fabricants de batteries lithium pour les distributeurs européens. Comparez les caractéristiques, les certifications et les options de personnalisation.',
      date: '2026-04-20',
    ...
    {
      slug: '5kw-solar-system-cost',
      title: 'Quel est le coût d\'installation d\'un système solaire de 5 kW aux États-Unis?',
      excerpt: 'Ventilation complète des coûts des systèmes solaires de 5 kW aux États-Unis pour 2026. Découvrez les équipements, la main-d\'œuvre et comment réduire les coûts d\'installation.',
      date: '2026-04-20',
      readTime: '6 min de lecture',
      category: 'Énergie Solaire',
      author: 'House Plus Ltd',
  ...
  es: [
    ...
    {
      slug: 'solar-inverter-guide',
      title: 'Cómo elegir el inversor solar adecuado para su hogar',
      excerpt: 'Aprenda a elegir el inversor solar adecuado para su hogar. Comparación de inversores de cadena, microinversores e inversores híbridos.',
      date: '2026-04-20',
    ...
    {
      slug: 'lithium-battery-manufacturers',
      title: 'Top 5 fabricantes de baterías de litio para distribuidores europeos',
      excerpt: 'Guía completa de los 5 principales fabricantes de baterías de litio para distribuidores europeos. Compare características, certificaciones y opciones de personalización.',
      date: '2026-04-20',
    ...
    {
      slug: '5kw-solar-system-cost',
      title: '¿Cuál es el costo de instalación de un sistema solar de 5 kW en los EE.UU.?',
      excerpt: 'Desglose completo de los costos del sistema solar de 5 kW en los EE.UU. para 2026. Conozca los equipos, la mano de obra y cómo reducir los costos de instalación.',
      date: '2026-04-20',
      readTime: '6 min de lectura',
      category: 'Energía Solar',
      author: 'House Plus Ltd',
  ...
  ar: [
    ...
    {
      slug: 'solar-inverter-guide',
      title: 'كيفية اختيار محول الطاقة الشمسية المناسب لمنزلك',
      excerpt: 'تعلم كيفية اختيار محول الطاقة الشمسية المناسب لمنزلك. مقارنة محولات السلسلة والمحولات الصغيرة والمحولات الهجينة.',
      date: '2026-04-20',
    ...
    {
      slug: 'lithium-battery-manufacturers',
      title: 'أفضل 5 مصنعي بطاريات الليثيوم للموزعين الأوروبيين',
      excerpt: 'دليل شامل لأفضل 5 مصنعي بطاريات الليثيوم للموزعين الأوروبيين. قارن الميزات والشهادات وخيارات التخصيص.',
      date: '2026-04-20',
    ...
    {
      slug: '5kw-solar-system-cost',
      title: 'ما هي تكلفة تثبيت نظام شمسي بقوة 5 كيلوواط في الولايات المتحدة؟',
      excerpt: 'تفصيل كامل لتكاليف نظام الطاقة الشمسية بقوة 5 كيلوواط في الولايات المتحدة لعام 2026. تعرف على المعدات والعمالة وكيفية تقليل تكاليف التثبيت.',
      date: '2026-04-20',
      readTime: '٦ دقائق قراءة',
      category: 'طاقة شمسية',
      author: 'House Plus Ltd',
